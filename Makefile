# Makefile for Cact audiod (kernel-message logger daemon)
...
build/audiod.o: main.c $(START_O) $(LIBC_SO)
	@mkdir -p build
	$(CC) $(CFLAGS) -c main.c -o $@

$(OUT): build/audiod.o $(START_O) $(LIBC_SO)
	@mkdir -p build/sbin
	$(LD) $(LDFLAGS) $(START_O) build/audiod.o $(LIBC_SO) -o $@

install: all
	@mkdir -p $(LR_SBIN)
	cp -f $(OUT) $(LR_SBIN)/audiod
